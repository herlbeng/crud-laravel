...
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/HomeComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/CreateComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/IndexComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/EditComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var routes = [{
  name: 'home',
  path: '/',
  component: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/HomeComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}, {
  name: 'create',
  path: '/create',
  component: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/CreateComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}, {
  name: 'posts',
  path: '/posts',
  component: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/IndexComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}, {
  name: 'edit',
  path: '/edit/:id',
  component: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/EditComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}];
...
__webpack_require__(/*! D:\xampp\htdocs\crud-laravel\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\xampp\htdocs\crud-laravel\resources\sass\app.scss */"./resources/sass/app.scss");
